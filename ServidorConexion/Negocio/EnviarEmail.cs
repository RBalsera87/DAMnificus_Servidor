...
namespace ServidorConexion.Negocio
{
    class EnviarEmail
    {
        public static bool registro(string email, string token)
        {
            ...
            oMail.From = "damnificus@gmail.com";

            // Set recipient email address
            oMail.To = email;

            // Set email subject
            oMail.Subject = "Bienvenido a DAMnificus";

            // Set email body
            oMail.HtmlBody = body1 + token + body2;
            ...
            oServer.User = "doomknight871@gmail.com";
            oServer.Password = "prodam$19";
